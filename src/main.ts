...
const champions: Champion[] = [
  ...
  { name: 'Bornova', image: 'Bornova.png', color: 'green' },
  ...
  { name: 'Fiamelia', image: 'Fiamelia.png', color: 'yellow' },
  ...
  { name: 'Kethos', image: 'Kethos.png', color: 'red' },
  ...
  { name: 'Palin', image: 'Palin.png', color: 'blue' },
  ...
  { name: 'Senyu', image: 'Senyu.png', color: 'red' },
